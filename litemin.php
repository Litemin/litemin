...
// Theme! If you want to change theme, save the CSS file
$theme = 'litemin.css';

// the default language! If you want to change it, save the language file in same folder of litemin or in folder "languages"
// More about localizations (downloads, how to translate etc.):
$language = 'pt';
...
//changing the following variable allows multiple litemin installs to work under the same domain.
$cookie_name = 'pla3412';
...
define('PROJECT_URL','https://github.com/Litemin/litemin');
define('DONATE_URL','http://colocarlink');
define('VERSION_CHECK_URL','https://github.com/Litemin/litemin');
define('PROJECT_BUGTRACKER_LINK','<a href="https://github.com/Litemin/litemin/issues" target="_blank">https://github.com/Litemin/litemin/issues</a>');
define('PROJECT_INSTALL_LINK','<a href="https://github.com/Litemin/litemin/wiki" target="_blank">https://github.com/Litemin/litemin/wiki</a>');
  ...
  //- Switch on $view (actually a series of if-else)
	...
	if($view=="structure")
	{
		...
		if ($auth->isPasswordDefault())
		{
			...
			echo sprintf($lang['warn_passwd'],(is_readable('litemin.config.php')?'litemin.config.php':PAGE))."<br />".$lang['warn0'];
			echo "</div>";
		}
		...
		while(!feof($csv_handle))
		{
			...
			if($csv_data[0] != NULL || count($csv_data)>1)
			{
				...
				foreach($csv_data as $csv_col => $csv_cell)
				{
					...
					{
						// the CSV row ends with the separator (like old litemin exported)
						break;
					}
...
class Resources {
	...
	private static $_resources = array(
		'css' => array(
			'mime' => 'text/css',
			'data' => 'resources/litemin.css',
		),
		'javascript' => array(
			'mime' => 'text/javascript',
			'data' => 'resources/litemin.js',
		),
		'favicon' => array(
			'mime' => 'image/x-icon',
...
function getInternalResource($res) {
	$resources = array('resources/litemin.css'=>array(0=>0,1=>3954,),'resources/litemin.js'=>array(0=>3954,1=>4178,),'resources/favicon.ico'=>array(0=>8132,1=>1448,),);
