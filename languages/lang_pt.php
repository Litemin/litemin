...
$lang = array(
	...
	"db_not_writeable" => "O Banco de Dados, '%s', não existe e não pode ser criado porque o diretório '%s' não ter permissão de escrita. O aplicativo está inutilizado para uso at� que isso seja sanado.",
	...
	"no_db2" => "O diretório que Você especificou não cont�m um banco de dados para gerenciar, al�m do diretório não poder ser gravado. Isso significa que Você não pode criar qualquer banco de dados usando %s. Ou fa�a com que o diretório seja grav�vel ou envie manualmente os bancos de dados para o diretório.",
	...
	"as_a" => "como",
	"readonly_tbl" => "'%s' é uma  (View), o que siginifica que é uma instrução SELECT tratado como tabela somente de leitura. Você não pode editar ou inserir dados.",
	...
	"new_fld" => "Adicionando novo(s) campo(s) é tabela '%s'",
	...
	"db_moved_outside" => "Ou Você tentou mover o banco de dados para um diretório que não pode mais ser gerenciado, ou verifique se isso falhou por causa de privil�gios perdidos.",
	...
	"directory_not_writable" => "O banco de dados em si � edit�vel, mas para escrever nele o diretório precisa ser grav�vel tamb�m. Isso acontece porque o SQLite coloca arquivos tempor�rios l� para fechamento.",
	...
	"help2_x" => "Quando Você cria um novo banco de dados o nome que Você escrever vai ser acrescentado de uma extens�o(.db, .db3, .sqlite etc.) se Você não a colocar por si mesmo(a).O banco de dados ser� criado no diretório que Você especificou com a vari�vel \$directory.",
